...
function Post({ post }) {
    ...
    return (
        <div className="w-[80%]   flex flex-col gap-[10px] bg-white items-center shadow-2xl shadow-[#00000058] rounded-sm pb-[20px]">
            <div className="w-full h-[80px] flex justify-between items-center px-[10px] bg-black">
                <div
            ...
            <div className="w-full h-[60px] flex justify-between items-center px-[20px] mt-[10px]">
                <div className="flex justify-center items-center gap-[10px] ">
                    <div className="flex justify-center items-center gap-[5px]">
                        ...
                        {post.likes.includes(userData._id) && (
                            <GoHeartFill
                                className="w-[25px] cursor-pointer h-[25px] text-lime-700"
                                onClick={handleLike}
                            />
                        )}
                ...
                <div onClick={handleSaved}>
                    ...
                    {userData.saved.includes(post?._id) && (
                        <GoBookmarkFill className="w-[25px] cursor-pointer h-[25px] text-lime-700 " />
                    )}
                </div>
            </div>
            {post.caption && (
            ...
            {showComment && (
                <div className="w-full  flex flex-col gap-[30px] pb-[20px]">
                    <div className="w-full h-[80px] flex items-center justify-between px-[20px] relative">
                        ...
                        >
                            <IoSendSharp className="w-[25px] h-[25px] text-lime-700" />
                        </button>
                    </div>
