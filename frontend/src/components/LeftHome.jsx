                ...
                >
                    ...
                    {notificationData?.length > 0 &&
                        notificationData.some(
                            ...
                            <div className="w-[10px] h-[10px] bg-yellow-400 rounded-full absolute top-0 right-[-5px]"></div>
                        )}
                </div>
            </div>
                    ...
                    <div className="flex items-center w-full justify-between gap-[10px] px-[10px] border-b-2 border-b-gray-900 py-[10px]">
                        <div className="flex items-center gap-[10px]">
                            ...
                            <div>
                                ...
                                <div className="text-[15px] text-gray-300 font-semibold ">
                                    {userData.name}
                                </div>
                            </div>
                        </div>
                        <div
                            className="text-gray-500 font-semibold cursor-pointer hover:text-lime-800 transition-colors"
