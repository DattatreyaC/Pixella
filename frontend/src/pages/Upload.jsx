...
function Upload() {
    ...
    return (
        <div className="w-full h-[100vh] bg-black flex flex-col items-center ">
            ...
            <div className="w-[90%] max-w-[600px] h-[80px] bg-lime-500 rounded-sm flex justify-around items-center gap-[10px]">
                <div
                    className={`${
                        uploadType == "post"
                            ? "bg-black text-white shadow-2xl shadow-black"
                            : ""
                    }  w-[28%] h-[80%] flex justify-center items-center text-[19px] font-semibold hover:bg-black rounded-sm hover:text-white cursor-pointer hover:shadow-2xl hover:shadow-black`}
            ...
            {!frontendMedia && (
                <div
                    className="w-[80%] max-w-[500px] h-[250px] bg-lime-700/30 border-lime-600 border-2 flex flex-col items-center justify-center gap-[8px] mt-[15vh] rounded-sm cursor-pointer hover:bg-lime-700/37 transition-colors duration-200"
