...
function MessageArea() {
    ...
    return (
        <div className="w-full h-[100vh] bg-black relative">
            <div className=" w-full flex items-center gap-[15px] px-[20px]  py-[10px] fixed top-0 z-[100] bg-black border-b border-white ">
                ...
                <div
                    className="w-[50px] h-[50px] border-b-2  border-black rounded-full cursor-pointer overflow-hidden "
                    onClick={() =>
            ...
            <div className="w-full h-full pt-[110px] px-[30px] sm:px-[50px] md:px-[75px] lg:px-[100px]  flex flex-col gap-5 overflow-auto bg-black">
                {messages &&
            ...
            <div className="w-full h-[80px] fixed bottom-0 flex justify-center items-center bg-black z-[100] ">
                <form
                    className="w-[90%] max-w-[800px] h-[80%] rounded-full bg-lime-700/20 flex items-center gap-[10px] px-[20px] relative"
                ...
                >
                    ...
                    {(input || frontendImage) && (
                        <button className="w-[60px] h-[40px] rounded-full bg-gradient-to-br from-lime-400 to-lime-700 flex items-center justify-center cursor-pointer">
