    ...
    return (
        <div className="w-full min-h-screen bg-black">
            <div className="w-full h-[80px] flex justify-between items-center px-[30px] text-white">
                ...
                <div
                    className="font-semibold cursor-pointer text-[20px] text-lime-500 "
            ...
            <div className="w-full h-[80px] flex justify-center items-center gap-[20px] mt-[10px]">
                {profileData?._id == userData._id && (
                    <button
                        className="px-[10px] min-w-[150px] py-[5px] h-[40px] bg-[white] cursor-pointer rounded-sm"
                ...
                {profileData?._id != userData._id && (
                    <>
                        ...
                        />
                        <button
                            className="px-[8px] min-w-[150px] py-[5px] h-[35px] bg-lime-400 cursor-pointer rounded-sm"
                            onClick={() => {
            ...
            <div className="w-full min-h-[100vh]  flex justify-center">
                <div className="w-full max-w-[900px] flex flex-col items-center rounded-t-[30px] bg-black relative gap-[20px] pt-[30px] pb-[100px]">
                    {profileData?._id == userData._id && (
                        <div className="w-[90%] max-w-[550px] h-[80px] bg-white rounded-sm flex justify-center items-center gap-[10px]">
                            <div
                                className={`${
                                    postType == "posts"
                                        ? "bg-lime-400 hover:bg-lime-400 text-black shadow-2xl shadow-black"
                                        : ""
                                }  w-[28%] h-[80%] flex justify-center items-center text-[19px] font-semibold hover:bg-lime-400/70  rounded-sm hover:text-black cursor-pointer hover:shadow-2xl hover:shadow-black`}
                            ...
                            <div
                                className={`${
                                    postType == "saved"
                                        ...
                                        : ""
                                }  w-[28%] h-[80%] flex justify-center items-center text-[19px] font-semibold hover:bg-lime-400/70 transition-all duration-250 hover:text-black rounded-sm  cursor-pointer hover:shadow-2xl hover:shadow-black`}
